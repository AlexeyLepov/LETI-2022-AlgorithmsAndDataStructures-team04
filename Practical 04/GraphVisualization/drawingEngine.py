...
class Node:
    ...
    def nextLeft(self):
        return self.children[0] if self.children else self.layout.thread

    def nextRight(self):
        return self.children[-1] if self.children else self.layout.thread
